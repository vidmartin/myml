...
from neural_network.batch_norm_v2 import BatchNormV2Module, BETA_PARAM_NAME, GAMMA_PARAM_NAME
import nodes
import utils

class BatchNormV2TestCase(unittest.TestCase):
    @override
    def setUp(self):
    ...
    def test_batch_norm_1d_no_affine(self):
        ...
        batch_norm_my_module = BatchNormV2Module(10, 1, learnable_affine=False)
    ...
    def test_batch_norm_1d(self):
        ...
        X_node = nodes.ConstantNode(X)
        batch_norm_my_module = BatchNormV2Module(10, 1)
        graph = batch_norm_my_module.construct(
            input=X_node,
            params={
    ...
    def test_batch_norm_2d(self):
        ...
        X_node = nodes.ConstantNode(X)
        batch_norm_my_module = BatchNormV2Module(10, 2)
        graph = batch_norm_my_module.construct(
            input=X_node,
            params={
                BETA_PARAM_NAME: init_beta,
    ...
    def test_batch_norm_3d(self):
        ...
        X_node = nodes.ConstantNode(X)
        batch_norm_my_module = BatchNormV2Module(10, 3)
        graph = batch_norm_my_module.construct(
            input=X_node,
            params={
                BETA_PARAM_NAME: init_beta,
